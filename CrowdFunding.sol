...
contract CrowdFunding 
{
    ...
    function sendEth() public payable 
    {
       ...
       if(Contributors[msg.sender] == 0)
            noOfContributors = noOfContributors.add(1);
        

        Contributors[msg.sender] = Contributors[msg.sender].add(msg.value);

        raiseAmount = raiseAmount.add(msg.value);
    }
    ...
    function VoteRequest(uint _requestNo ) public
    {
        ...
        thisRequest.noOfVoters = thisRequest.noOfVoters.add(1);
    }
    ...
    function makePayment(uint _requestNo) public onlyMnager
    {
        ...
        require(thisRequest.noOfVoters > noOfContributors.div(2)  , "Majority does not support");
